# Script para eliminar sidebar de archivos HTML (excepto layouts) - Version mejorada
$folder = "figma-export"
...
foreach ($file in $files) {
    ...
    # Eliminar bloque aside completo (cualquier variante)
    $content = $content -replace '(?s)\s*<aside[^>]*>.*?</aside>', ''
